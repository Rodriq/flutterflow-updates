...
class HWidget extends StatefulWidget {
  const HWidget({super.key});

  static String routeName = 'h';
  static String routePath = '/h';

  @override
  State<HWidget> createState() => _HWidgetState();
}

class _HWidgetState extends State<HWidget> {
  late HModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HModel());
